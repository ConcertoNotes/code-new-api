	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/lottery/admin/overview", controller.GetLotteryAdminOverview)
				adminRoute.GET("/lottery/admin/draws", controller.GetLotteryAdminDraws)
				adminRoute.POST("/topup/complete", controller.AdminCompleteTopUp)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.GET("/group-access-options", controller.GetUserGroupAccessOptions)
				adminRoute.GET("/:id/oauth/bindings", controller.GetUserOAuthBindingsByAdmin)
				adminRoute.DELETE("/:id/oauth/bindings/:provider_id", controller.UnbindCustomOAuthByAdmin)
				adminRoute.DELETE("/:id/bindings/:binding_type", controller.AdminClearUserBinding)
				adminRoute.GET("/:id/visible-groups", controller.GetUserVisibleGroups)
				adminRoute.PUT("/:id/visible-groups", controller.UpdateUserVisibleGroups)
		...
		dataRoute.GET("/profit", middleware.AdminAuth(), controller.GetChannelProfitStats)
		dataRoute.PUT("/profit/upstream_ratio", middleware.AdminAuth(), controller.UpdateChannelUpstreamRatio)
		dataRoute.PUT("/profit/settings", middleware.AdminAuth(), controller.UpdateProfitSettings)
