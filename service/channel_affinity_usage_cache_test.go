...
func uniqueChannelAffinityUsageCacheKeyForTest(t *testing.T, prefix string) string {
	t.Helper()
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityUsageCacheKeyForTest(t, "rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityUsageCacheKeyForTest(t, "fp")
