              ...
              <FieldGroup className='min-w-0'>
                ...
                >
                  <Tabs
                    ...
                    className='gap-4'
                  >
                    <TabsList className='grid w-full auto-rows-7 grid-cols-2 group-data-horizontal/tabs:h-auto sm:grid-cols-4'>
                      <TabsTrigger value='tiered_expr'>
                        {t('Expression')}
                      </TabsTrigger>
                      <TabsTrigger value='per-video'>
                        {t('Video per second')}
                      </TabsTrigger>
