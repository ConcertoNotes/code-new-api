...
} from '../top-nav-link-data.ts'

test('documentation navigation uses the configured external link', () => {
  assert.deepEqual(getDocumentationLink('Docs', 'https://docs.example.com'), {
    title: 'Docs',
