...
test('decorated submit and disabled buttons retain form and keyboard behavior', async () => {
...
test('icon and link buttons preserve accessible labels and destinations', () => {
  render(
    <>
