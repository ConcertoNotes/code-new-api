...
import { Route as DocsGptImageRouteImport } from './routes/docs/gpt-image'
...
const DocsGptImageRoute = DocsGptImageRouteImport.update({
  id: '/gpt-image',
  path: '/gpt-image',
  getParentRoute: () => DocsRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/docs/gpt-image': typeof DocsGptImageRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/docs/gpt-image': {
      id: '/docs/gpt-image'
      path: '/gpt-image'
      fullPath: '/docs/gpt-image'
      preLoaderRoute: typeof DocsGptImageRouteImport
      parentRoute: typeof DocsRouteRoute
    }
    '/docs/gpt-image-2': {
      id: '/docs/gpt-image-2'
      ...
      preLoaderRoute: typeof DocsGptImage2RouteImport
      parentRoute: typeof DocsRouteRoute
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
...
interface DocsRouteRouteChildren {
  DocsGptImageRoute: typeof DocsGptImageRoute
  DocsGptImage2Route: typeof DocsGptImage2Route
  DocsIndexRoute: typeof DocsIndexRoute
}

const DocsRouteRouteChildren: DocsRouteRouteChildren = {
  DocsGptImageRoute: DocsGptImageRoute,
