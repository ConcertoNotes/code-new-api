...
export const STATIC_I18N_KEYS = [
  ...
  // Degradation check (see features/quality-test/constants.ts)
  'Pelican riding a bicycle',
  'Polar bear riding a bicycle',
  'Ultraman riding a motorcycle',
  'Octopus playing drums',
  'Giraffe on a skateboard',
  'Astronaut cat fishing on the moon',
  'Analog clock',
  'Solar system',
  'Bouncing balls physics',
  'Meshing gears',
  'Parallax city at night',
  'Stroke order of 永',
  'Waiting for a test',
  'Generating',
  'Stopping',
  ...
  'Timed out while exporting the SVG',
  'No visible SVG found in the preview',
  'This SVG uses features that cannot be exported',
  'The SVG is too large to export',
  'The preview is not ready yet',
  'Failed to export the SVG',
] as const
